 ...
 */
struct IndexTagRecord: Identifiable, TableRecord, TagAssociation, Sendable {
...
extension IndexTagRecord {
  
  /**
   * Describes a set of changes (additions and deletions) made in the IndexTagRecord table
   */
  typealias ChangeSet = (added: [IndexTagRecord], removed: [IndexTagRecord])
}
