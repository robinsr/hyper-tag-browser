...
//    
//    do {
//      try LocalFileService(monitoring: false).rename(task.previous, to: task.updated)
//    } catch {
...
//    let logger = CustomLogger("DatabaseRegionObservation")
//    
//    let onErrorFn: @Sendable (Error) -> Void = { error in
//      logger.emit(.error, ErrorMsg("Error in database observer '\(name)'", error))
//    }
//    
