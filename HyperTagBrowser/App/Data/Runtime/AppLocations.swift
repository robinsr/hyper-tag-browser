...
struct UserLocation {
  ...
  static let desktop = FileManager.default.homeDirectoryForCurrentUser.appending(path: "Desktop", directoryHint: .isDirectory)
...
struct AppLocation {
  static let appSupport: FilePath = SystemLocation.appSupport.appending(Constants.appDisplayName)
  static let preferences: FilePath = UserLocation.homePath.appending("Library/Preferences")
  static let caches: FilePath = UserLocation.caches.appending(Constants.appDisplayName)
}
