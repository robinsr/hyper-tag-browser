...
struct TagRecordFixture: DatabaseTestFixtureType {
  ...
  enum Cases: String, CaseIterable, Filterable, Sendable {
    case donuts = "tag|donuts"
    case chicken = "tag|chicken"
    case porkchop = "tag|porkchop"
    case soup = "tag|soup"
    case cookies = "tag|cookies"
    case cake = "tag|cake"
    case pie = "tag|pie"
    case pancakes = "tag|pancakes"
    case waffles = "tag|waffles"
    ...
    var asRow: DatabaseFixtureRow {
      ...
      return [
        ...
        "tagValue": filter.value.databaseValue,
        "tagType": filter.type.rawValue.databaseValue,
        "entryType": TagRecord.EntryType.normal.rawValue.databaseValue,
      ]
    }
